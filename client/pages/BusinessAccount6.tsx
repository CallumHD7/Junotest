...
export default function BusinessAccount6() {
  ...
  return (
    <div className="flex flex-col w-full h-screen overflow-y-auto bg-gradient-radial from-[#26272B] via-[#26272B] to-[#18181B] relative">
              ...
              <div className="flex h-12 px-4 pr-3 items-center gap-3 self-stretch rounded-lg bg-[#3F3F46] border border-transparent focus-within:border-[#A0A0AB] transition-colors relative">
                <select
                  ...
                  className={`flex-1 bg-transparent text-[14px] font-medium leading-[20px] uppercase border-none outline-none appearance-none ${
                    formData.inboundTransactions ? "text-white" : "text-[#A0A0AB]"
                  }`}
                >
            ...
            <div className="flex flex-col items-start gap-2 self-stretch relative">
              ...
              <div className="flex h-12 px-4 pr-3 items-center gap-3 self-stretch rounded-lg bg-[#3F3F46] border border-transparent focus-within:border-[#A0A0AB] transition-colors relative">
                <select
                  ...
                  className={`flex-1 bg-transparent text-[14px] font-medium leading-[20px] uppercase border-none outline-none appearance-none ${
                    formData.inboundUsdValue ? "text-white" : "text-[#A0A0AB]"
                  }`}
                >
                  <option value="" className="bg-[#3F3F46] text-[#A0A0AB]">SELECT AMOUNT</option>
            ...
            <div className="flex flex-col items-start gap-2 self-stretch relative">
              ...
              <div className="flex h-12 px-4 pr-3 items-center gap-3 self-stretch rounded-lg bg-[#3F3F46] border border-transparent focus-within:border-[#A0A0AB] transition-colors relative">
                <select
                  ...
                  className={`flex-1 bg-transparent text-[14px] font-medium leading-[20px] uppercase border-none outline-none appearance-none ${
                    formData.inboundCurrencies ? "text-white" : "text-[#A0A0AB]"
                  }`}
                >
            ...
            <div className="flex flex-col items-start gap-2 self-stretch relative">
              ...
              <div className="flex h-12 px-4 pr-3 items-center gap-3 self-stretch rounded-lg bg-[#3F3F46] border border-transparent focus-within:border-[#A0A0AB] transition-colors relative">
                <select
                  ...
                  className={`flex-1 bg-transparent text-[14px] font-medium leading-[20px] uppercase border-none outline-none appearance-none ${
                    formData.inboundJurisdictions ? "text-white" : "text-[#A0A0AB]"
                  }`}
                >
                  <option value="" className="bg-[#3F3F46] text-[#A0A0AB]">SELECT CURRENCIES</option>
            ...
            <div className="flex flex-col items-start gap-2 self-stretch relative">
              ...
              <div className="flex h-12 px-4 pr-3 items-center gap-3 self-stretch rounded-lg bg-[#3F3F46] border border-transparent focus-within:border-[#A0A0AB] transition-colors relative">
                <select
                  ...
                  className={`flex-1 bg-transparent text-[14px] font-medium leading-[20px] uppercase border-none outline-none appearance-none ${
                    formData.outboundTransactions ? "text-white" : "text-[#A0A0AB]"
                  }`}
                >
                  <option value="" className="bg-[#3F3F46] text-[#A0A0AB]">SELECT AMOUNT</option>
                  <option value="1-5" className="bg-[#3F3F46] text-white">1-5</option>
            ...
            <div className="flex flex-col items-start gap-2 self-stretch relative">
              ...
              <div className="flex h-12 px-4 pr-3 items-center gap-3 self-stretch rounded-lg bg-[#3F3F46] border border-transparent focus-within:border-[#A0A0AB] transition-colors relative">
                <select
                  ...
                  className={`flex-1 bg-transparent text-[14px] font-medium leading-[20px] uppercase border-none outline-none appearance-none ${
                    formData.outboundCurrencies ? "text-white" : "text-[#A0A0AB]"
                  }`}
                >
                  <option value="" className="bg-[#3F3F46] text-[#A0A0AB]">SELECT CURRENCIES</option>
                  <option value="usd" className="bg-[#3F3F46] text-white">USD</option>
            ...
            <div className="flex flex-col items-start gap-2 self-stretch relative">
              ...
              <div className="flex h-12 px-4 pr-3 items-center gap-3 self-stretch rounded-lg bg-[#3F3F46] border border-transparent focus-within:border-[#A0A0AB] transition-colors relative">
                <select
                  ...
                  className={`flex-1 bg-transparent text-[14px] font-medium leading-[20px] uppercase border-none outline-none appearance-none ${
                    formData.fxUsdValue ? "text-white" : "text-[#A0A0AB]"
                  }`}
                >
                  <option value="" className="bg-[#3F3F46] text-[#A0A0AB]">SELECT AMOUNT</option>
                  <option value="under-1000" className="bg-[#3F3F46] text-white">UNDER $1,000</option>
      ...
      {/* Bottom Section */}
      <div className="flex px-4 pt-6 pb-6 sm:pb-2 flex-col items-start gap-6 self-stretch border-t border-[#51525C] relative bg-[#26272B]">
        {/* Continue Button */}
        <button 
      ...
      {showModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-2 bg-[rgba(0,0,0,0.56)]" onClick={handleModalCancel}>
          <div className="flex flex-col items-start rounded-lg border border-[#51525C] bg-[#26272B] relative w-auto max-w-[360px] overflow-hidden" onClick={(e) => e.stopPropagation()}>
            {/* Close Button */}
            <button
              onClick={handleModalCancel}
              className="absolute top-5 right-5 w-6 h-6 z-10"
            >
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
            ...
            <div className="flex p-5 flex-col items-center gap-6 self-stretch">
              <div className="flex flex-col items-center gap-4 self-stretch">
                <h2 className="self-stretch text-white text-[18px] font-semibold leading-[28px] tracking-[0.18px] uppercase text-left sm:text-center">
            ...
            <div className="flex items-start self-stretch">
              <button
                onClick={handleModalCancel}
                className="flex h-14 p-6 flex-col justify-center items-center gap-3 flex-1 border-t border-[#51525C] bg-[#2F3033] sm:bg-transparent transition-opacity hover:opacity-80"
              >
