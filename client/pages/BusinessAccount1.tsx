...
export default function BusinessAccount1() {
  ...
  return (
    <div className="flex flex-col w-full h-screen overflow-y-auto bg-gradient-radial from-[#26272B] via-[#26272B] to-[#18181B] relative">
      ...
      <div className="sticky top-0 z-30 flex px-4 py-6 flex-col items-start gap-7 self-stretch bg-[#26272B] sm:bg-[#26272B]/95">
        {/* Back Button */}
        <button 
          onClick={handleBack}
        ...
        <div className="flex flex-col items-start gap-6 self-stretch relative">
          ...
          <div className="flex flex-col items-start gap-2 self-stretch relative">
            ...
            <input
              ...
              className="flex h-12 px-4 justify-between items-center self-stretch rounded-lg bg-[#3F3F46] text-white text-sm font-medium leading-5 uppercase placeholder-[#A0A0AB] border border-transparent focus:border-[#A0A0AB] outline-none transition-colors"
            />
          </div>
