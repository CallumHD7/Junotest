            ...
            <div className="flex flex-col items-center gap-2.5 cursor-pointer relative" onClick={() => setShowMoreDropdown(!showMoreDropdown)}>
              ...
              {showMoreDropdown && (
                <>
                  ...
                  {/* Dropdown Menu */}
                  <div className="absolute top-full mt-2 left-0 z-50 flex flex-col w-40 rounded-lg border border-[#E4E4E7] bg-white shadow-[0_5px_14px_0_rgba(0,0,0,0.15)] overflow-hidden">
                    {/* FX Option */}
                    <div
