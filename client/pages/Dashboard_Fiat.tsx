...
export default function Dashboard_Fiat() {
  ...
  const [showIbanCurrencyDropdown, setShowIbanCurrencyDropdown] =
    useState(false);
  const [showIbanDetailsOverlay, setShowIbanDetailsOverlay] = useState(false);
  const [showCryptoDepositOverlay, setShowCryptoDepositOverlay] =
    useState(false);
  const [showCryptoSendDropdown, setShowCryptoSendDropdown] = useState(false);
  const [showCryptoReceiveDropdown, setShowCryptoReceiveDropdown] =
    useState(false);
  ...
  const [showWithdrawalCurrencyDropdown, setShowWithdrawalCurrencyDropdown] =
    useState(false);

  // Third-Party Payment overlay state
  const [showThirdPartyPaymentOverlay, setShowThirdPartyPaymentOverlay] =
    useState(false);
  const [thirdPartyPaymentTab, setThirdPartyPaymentTab] = useState("new"); // "new" or "saved"
  const [thirdPartyPaymentAmount, setThirdPartyPaymentAmount] =
    useState("900.00");
  const [thirdPartyPaymentCurrency, setThirdPartyPaymentCurrency] =
    useState("EUR");
  const [
    showThirdPartyPaymentCurrencyDropdown,
    setShowThirdPartyPaymentCurrencyDropdown,
  ] = useState(false);
  ...
  const [showTransferCurrencyDropdown, setShowTransferCurrencyDropdown] =
    useState(false);
  const [transferEmailAddress, setTransferEmailAddress] =
  ...
  useEffect(() => {
    const handleClickOutside = (event: MouseEvent) => {
      if (
        showMoreDropdown &&
        !(event.target as Element).closest('[data-dropdown="more"]')
      ) {
        setShowMoreDropdown(false);
      }
      if (
        showFxFromDropdown &&
        !(event.target as Element).closest('[data-dropdown="fx-from"]')
      ) {
        setShowFxFromDropdown(false);
      }
      if (
        showFxToDropdown &&
        !(event.target as Element).closest('[data-dropdown="fx-to"]')
      ) {
        ...
        <div className="w-full h-11 bg-white flex items-center justify-between px-5 relative">
          ...
          <div className="flex items-center gap-1">
            ...
            <svg width="16" height="14" viewBox="0 0 16 14" fill="none">
              <path
                d="M8.13198 8.94141C8.77147 8.94141 9.39286 9.10945 9.94037 9.42987L10.1622 9.5597C10.3304 9.65813 10.36 9.88848 10.2221 10.026L8.328 11.9148C8.21166 12.0308 8.02303 12.0308 7.90669 11.9148L6.02478 10.0381C5.88749 9.90122 5.91611 9.67204 6.08287 9.57289L6.30222 9.44247C6.85476 9.11394 7.48403 8.94141 8.13198 8.94141Z"
                fill="#18181B"
              />
              <path
                d="M8.13657 5.46875C9.72741 5.46875 11.2548 5.99649 12.4991 6.97382L12.675 7.11194C12.8152 7.22205 12.8275 7.42955 12.7013 7.55539L11.5705 8.68302C11.4659 8.78732 11.3004 8.7993 11.1818 8.71116L11.044 8.60871C10.2036 7.98413 9.19024 7.6491 8.13657 7.6491C7.07642 7.6491 6.05714 7.9883 5.21396 8.62005L5.07597 8.72343C4.95737 8.8123 4.79127 8.8006 4.68637 8.69599L3.55601 7.56877C3.43008 7.44319 3.44204 7.23622 3.58159 7.1259L3.75644 6.98766C5.00369 6.00163 6.53806 5.46875 8.13657 5.46875Z"
                fill="#18181B"
              />
              <path
        ...
        <div className="w-full h-[678px] p-4 flex flex-col gap-6 bg-white border-t border-black/[0.12] rounded-lg mt-[2px]">
          ...
          <div className="flex flex-col gap-3">
            ...
            <p className="text-[#51525C] text-sm font-medium uppercase">
              FOR BEST RESULTS, COMPLETE AND UPLOAD OUR BULK PAY CSV TEMPLATE
              PROVIDED BELOW.
            </p>
          </div>
          ...
          <div className="flex flex-col gap-2">
            ...
            <div className="flex h-[52px] px-3 items-center gap-3 border border-[#D1D1D6] rounded-lg bg-[#FAFAFA]">
              <label className="flex px-2 py-2 justify-center items-center gap-2.5 border border-[#51525C] rounded bg-[#E4E4E7] cursor-pointer">
                <span className="text-[#18181B] text-xs font-medium uppercase">
                  CHOOSE FILE
                </span>
                <input
                  type="file"
          ...
          <button
            className={`flex h-11 px-8 py-3 justify-center items-center gap-2.5 self-stretch rounded-lg transition-opacity ${
              selectedFile
                ...
                : "bg-[#18181B] opacity-50"
            }`}
            disabled={!selectedFile}
          >
            <span className="text-white text-center text-sm font-semibold uppercase">
              CONTINUE
            </span>
          </button>
          ...
          {/* Warning Text */}
          <p className="text-[#51525C] text-sm font-medium uppercase">
            MAKE SURE YOU COMPLETE ALL THE MANDATORY FIELDS. OTHERWISE YOUR
  ...
  return (
    <div className="w-full min-h-[714px] bg-[#fbfbfb] sm:bg-[#F4F4F5] flex flex-col pb-[70px]">
      ...
      <div className="w-full h-[606px] relative overflow-hidden">
        ...
        <div className="w-full h-[52px] flex items-center justify-between px-4 py-[15px] relative rounded-b-[4px] top-2">
          ...
          <div className="flex items-center">
            ...
            >
              <path
                d="M35.7188 11.3464C35.7188 7.35977 38.2487 4.57422 42.0054 4.57422C45.6599 4.57422 48.1643 7.28311 48.1643 11.3209C48.1643 15.3587 45.6599 18.0676 41.9799 18.0676C38.2999 18.0676 35.7188 15.3587 35.7188 11.3464ZM38.351 11.3464C38.351 13.9276 39.8587 15.5887 41.9543 15.5887C44.0754 15.5887 45.5321 13.9276 45.5321 11.3209C45.5321 8.73977 44.1265 7.02755 42.0054 7.02755C39.8843 7.02755 38.351 8.73977 38.351 11.3464Z"
                fill="#18181B"
              />
              <path
                d="M22.7031 4.95755H25.3865V8.22866C25.9231 5.95422 27.5331 4.57422 29.7565 4.57422C32.4909 4.57422 33.7176 6.69533 33.7176 9.78755V17.6587H31.0342V10.7076C31.0342 8.20311 30.2165 6.84866 28.3765 6.84866C26.6387 6.84866 25.4631 8.04978 25.3865 9.88977V17.6587H22.7031V4.95755Z"
                fill="#18181B"
              />
              <path
                d="M20.0301 4.98438V17.6599H17.3467V14.4399C16.7845 16.6888 15.1745 18.0433 12.9767 18.0433C10.2678 18.0433 9.01562 15.9222 9.01562 12.8299V4.98438H11.699V11.9099C11.699 14.4399 12.5167 15.7688 14.3567 15.7688C16.0434 15.7688 17.219 14.6444 17.3467 12.881V4.98438H20.0301Z"
                fill="#18181B"
              />
              <path
                d="M3.75667 0H6.59333V2.81111H3.75667V0ZM3.83333 4.98333H6.51667V18.0933C6.51667 20.8022 5.52 23 2.78556 23C1.45667 23 0.613333 22.3867 0 21.7989L0.971111 19.5756C1.38 20.0867 1.76333 20.4956 2.45333 20.4956C3.78222 20.4956 3.83333 19.0389 3.83333 17.1478V4.98333Z"
                fill="#18181B"
              />
            </svg>
          </div>
        ...
        <div className="absolute left-1/2 top-[124px] transform -translate-x-1/2 w-[300px] h-[300px]">
          ...
          >
            <path
              d="M150.5 4.61538C169.592 4.61538 188.497 8.37587 206.136 15.6821C223.775 22.9884 239.802 33.6973 253.302 47.1976C266.803 60.6978 277.512 76.7248 284.818 94.3637C292.124 112.003 295.885 130.908 295.885 150C295.885 169.092 292.124 187.997 284.818 205.636C277.512 223.275 266.803 239.302 253.302 252.802C239.802 266.303 223.775 277.012 206.136 284.318C188.497 291.624 169.592 295.385 150.5 295.385"
              stroke="#0067E1"
              strokeWidth="9.23077"
            />
            <path
              d="M149.58 295.382C123.664 295.218 98.2626 288.129 76.0065 274.85"
              stroke="#FF002E"
              strokeWidth="9.23077"
            />
            <path
              d="M16.501 93.6001C22.8095 78.6118 31.588 64.7881 42.4708 52.7047"
              stroke="#FF0004"
              strokeWidth="9.23077"
            />
            <path
              d="M75.2175 274.375C45.5103 256.394 23.2204 228.374 12.3804 195.384C1.54053 162.394 2.8667 126.613 16.119 94.5164"
              stroke="#0074FF"
              strokeWidth="9.23077"
            />
            <path
              d="M104.649 12.0348C119.115 7.22716 134.248 4.72462 149.492 4.61888"
              stroke="#6DA544"
              strokeWidth="9.23077"
            />
            <path
              d="M43.3058 51.7855C59.8013 33.7818 80.5657 20.2228 103.683 12.3597"
              stroke="#0091FF"
              strokeWidth="9.23077"
            />
          </svg>
          ...
          <div className="absolute inset-0 flex items-center justify-center">
            <div className="flex items-baseline">
              ...
              <span className="text-[#18181B] text-[40px] font-semibold">
                3,749,002
              </span>
            </div>
          </div>
        ...
        <div className="absolute bottom-0 left-0 w-full flex flex-col items-center gap-2.5 px-3 pb-[40px]">
          <div className="flex items-center gap-3">
            ...
            >
              ...
              <span className="text-[#51525C] text-center text-[10px] font-semibold leading-normal">
                DEPOSIT
              </span>
            </div>
            ...
            <div
              className="flex flex-col items-center gap-2.5 cursor-pointer"
              onClick={() => setShowWithdrawalOverlay(true)}
            >
              <div className="w-[60px] h-[60px] rounded-lg bg-[#E4E4E7] flex items-center justify-center p-2 backdrop-blur-[12px]">
                <svg width="30" height="30" viewBox="0 0 24 24" fill="none">
                  <path
            ...
            <div
              className="flex flex-col items-center gap-2.5 cursor-pointer"
              onClick={() => setShowThirdPartyPaymentOverlay(true)}
            >
              <div className="w-[60px] h-[60px] rounded-lg bg-[#E4E4E7] flex items-center justify-center p-2 backdrop-blur-[12px]">
                <img
            ...
            <div className="flex p-[18px] px-3 flex-col items-start gap-3 self-stretch rounded-lg border border-black/[0.12] bg-white">
              <div className="flex items-center gap-3 self-stretch">
                ...
                <div className="flex w-full flex-col justify-center items-start gap-0.5">
                  ...
                  <div className="w-[79px] text-[#51525C] text-sm font-medium leading-5">
                    USD
                  </div>
                </div>
                <div className="flex flex-col justify-center items-end gap-0.5 flex-1">
                  <div className="text-[#18181B] text-right text-sm font-semibold leading-5">
                    $44,955.02
                  </div>
                </div>
              </div>
              <div className="flex flex-col justify-center items-start gap-1 self-stretch">
                <div className="text-[#18181B] text-sm font-medium leading-5">
                  65.6%
                </div>
            ...
            <div className="flex p-[18px] px-3 flex-col items-start gap-3 self-stretch rounded-lg border border-black/[0.12] bg-white">
              <div className="flex items-center gap-3 self-stretch">
                ...
                <div className="flex flex-col justify-center items-end gap-0.5 flex-1">
                  ...
                  <div className="text-[#51525C] text-right text-sm font-medium leading-5">
                    $3,000.00
                  </div>
                </div>
              </div>
        ...
        <div className="flex flex-col items-center self-stretch rounded-lg border border-black/[0.12] bg-white w-full">
          ...
          <div className="flex p-3 items-center gap-2 self-stretch">
            <div className="flex items-center gap-1 flex-1">
              <h2 className="text-[#3F3F46] text-sm font-bold leading-5">
                SAVED BANK ACCOUNTS
              </h2>
              <div className="flex w-4 h-4 px-0.5 flex-col justify-center items-center rounded bg-[#E4E4E7]">
                <span className="text-[#18181B] text-center text-[8px] font-bold leading-3 tracking-[0.16px]">
                  9
                </span>
              </div>
            </div>
          ...
          <div className="flex px-3 pb-3 items-start content-start gap-1 self-stretch flex-wrap">
            ...
            <div className="flex w-[calc(50%-2px)] h-44 p-3 flex-col justify-between items-start rounded-md bg-[#F4F4F5]">
              <div className="w-11 h-11 flex-shrink-0 rounded-full bg-[#E4E4E7] relative">
                ...
                >
                  <path
                    d="M4.99406 9.01156H3.01406V15.9416H4.99406V9.01156ZM10.9341 9.01156H8.95406V15.9416H10.9341V9.01156ZM19.3491 17.9216H0.539062V19.9016H19.3491V17.9216ZM16.8741 9.01156H14.8941V15.9416H16.8741V9.01156ZM9.94406 2.33896L15.102 5.05156H4.78616L9.94406 2.33896ZM9.94406 0.101562L0.539062 5.05156V7.03156H19.3491V5.05156L9.94406 0.101562Z"
                    fill="#26272B"
                  />
                </svg>
              ...
              <div className="flex flex-col items-start gap-1 self-stretch">
                <div className="self-stretch text-[#51525C] text-[10px] font-medium leading-3 uppercase">
                  LANdlord
                </div>
                <div className="self-stretch text-[#18181B] text-sm font-bold leading-5 uppercase">
                  Leonardo Bianchi
                </div>
            ...
            <div className="flex w-[calc(50%-2px)] h-44 p-3 flex-col justify-between items-start rounded-md bg-[#F4F4F5]">
              <div className="w-11 h-11 flex-shrink-0 rounded-full bg-[#E4E4E7] relative">
                ...
                >
                  <path
                    d="M4.49406 9.01156H2.51406V15.9416H4.49406V9.01156ZM10.4341 9.01156H8.45406V15.9416H10.4341V9.01156ZM18.8491 17.9216H0.0390625V19.9016H18.8491V17.9216ZM16.3741 9.01156H14.3941V15.9416H16.3741V9.01156ZM9.44406 2.33896L14.602 5.05156H4.28616L9.44406 2.33896ZM9.44406 0.101562L0.0390625 5.05156V7.03156H18.8491V5.05156L9.44406 0.101562Z"
                    fill="#26272B"
                  />
                </svg>
                <div className="absolute -top-1 left-[30px] w-[22px] h-[22px] rounded-full border-[1.837px] border-white overflow-hidden flex flex-col justify-center items-start">
          ...
          <div className="flex p-3 flex-col items-start gap-2.5 self-stretch">
            <div className="flex h-10 py-3 px-0 justify-center items-center gap-2.5 self-stretch rounded bg-[#E4E4E7]">
              <div className="text-[#18181B] text-center text-sm font-bold leading-5">
                SEE ALL
              </div>
            </div>
          </div>
          ...
          <div className="flex p-3 flex-col justify-center items-start gap-3 self-stretch">
            ...
            <div className="flex h-10 py-2 px-3 pr-2 items-center gap-0.5 self-stretch rounded border border-[#D1D1D6] bg-[#FCFCFC]">
              <div className="flex flex-col items-start flex-1">
                <div className="self-stretch text-[#18181B] text-sm font-medium leading-5 tracking-[0.28px] uppercase">
                  28 Dec 22 – 10 Jan 23
                </div>
              </div>
              <svg
              ...
              <div className="flex w-[260px] p-3 flex-col items-start gap-4 flex-shrink-0 rounded-md bg-[#F4F4F5]">
                <div className="flex justify-between items-start self-stretch">
                  ...
                  <div className="flex w-8 h-8 p-1.5 justify-center items-center gap-2 rounded-full bg-[#E4E4E7]">
                    <svg width="18" height="18" viewBox="0 0 18 18" fill="none">
                      <path
                        d="M15.7041 5.04785L15.6328 5.11816L6.68457 14.0664L6.61426 14.1377L2.30371 9.82715L2.375 9.75684L3.43359 8.70508L3.50488 8.63477L3.5752 8.70508L6.61328 11.7441L14.4404 3.92578L14.5107 3.85449L15.7041 5.04785Z"
                        fill="#18181B"
                        stroke="#18181B"
                        strokeWidth="0.2"
                      />
              ...
              <div className="flex w-[260px] p-3 flex-col items-start gap-4 flex-shrink-0 rounded-md bg-[#F4F4F5]">
                ...
                <div className="flex items-center gap-1.5 self-stretch">
                  <div className="flex items-center gap-[11.429px]">
                    <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
                      <path
                        d="M15.0446 6.66536H4.9502C4.25122 6.66536 3.90119 7.51686 4.39542 8.01486L9.44265 13.1005C9.74898 13.4092 10.2458 13.4092 10.5521 13.1005L15.5993 8.01486C16.0936 7.51686 15.7436 6.66536 15.0446 6.66536Z"
                        fill="#A30D0D"
                      />
                    </svg>
                  </div>
          ...
          <div className="flex flex-col items-start self-stretch">
            ...
            <div className="flex h-[76px] px-3 items-center gap-3 self-stretch">
              <svg width="44" height="44" viewBox="0 0 44 44" fill="none">
                ...
                <path
                  d="M27.1874 16.8128L16.8165 27.1837"
                  stroke="#18181B"
                  strokeWidth="2.2"
                  strokeLinecap="round"
                  strokeLinejoin="round"
                />
                <path
                  d="M27.1875 25.8906V16.8161H18.113"
                  stroke="#18181B"
                  strokeWidth="2.2"
                  strokeLinecap="round"
                  strokeLinejoin="round"
              ...
              <div className="flex flex-col justify-center items-end gap-0.5">
                <div className="flex py-0.5 px-1 justify-center items-center gap-2.5 rounded bg-[rgba(170,170,187,0.16)]">
                  <div className="text-[#26272B] text-center text-xs font-bold leading-4 tracking-[0.24px] uppercase">
                    awaiting approval
                  </div>
                </div>
            ...
            <div className="flex h-[76px] px-3 items-center gap-3 self-stretch">
              <div className="flex w-11 h-11 p-[11px] justify-center items-center rounded-full bg-[#E4E4E7]">
                <svg width="22" height="22" viewBox="0 0 22 22" fill="none">
                  <path
                    d="M13.7361 6.44523H8.26944M13.7361 10.0897H8.26944M13.7361 13.7341H10.0917M4.625 2.80078H17.3806V19.2008L16.4403 18.3954C16.11 18.1123 15.6894 17.9567 15.2545 17.9567C14.8195 17.9567 14.3989 18.1123 14.0687 18.3954L13.1284 19.2008L12.189 18.3954C11.8587 18.1121 11.4379 17.9563 11.0028 17.9563C10.5676 17.9563 10.1468 18.1121 9.81651 18.3954L8.87716 19.2008L7.93689 18.3954C7.60663 18.1123 7.18603 17.9567 6.75108 17.9567C6.31613 17.9567 5.89552 18.1123 5.56527 18.3954L4.625 19.2008V2.80078Z"
                    stroke="#18181B"
                    strokeWidth="1.78909"
                    strokeLinecap="round"
                    strokeLinejoin="round"
            ...
            <div className="flex h-[76px] px-3 items-center gap-3 self-stretch">
              <svg width="44" height="44" viewBox="0 0 44 44" fill="none">
                <rect width="44" height="44" rx="22" fill="#E4E4E7" />
                <path
                  d="M16.8126 27.1911L27.1835 16.8202"
                  stroke="#18181B"
                  strokeWidth="2.2"
                  strokeLinecap="round"
                  strokeLinejoin="round"
                />
                <path
                  d="M16.8125 18.1133V27.1878H25.887"
                  stroke="#18181B"
                  strokeWidth="2.2"
                  strokeLinecap="round"
                  strokeLinejoin="round"
            ...
            <div className="flex h-[76px] px-3 items-center gap-3 self-stretch">
              ...
              <div className="flex flex-col justify-center items-end gap-0.5">
                <div className="flex px-1 py-0.5 justify-center items-center gap-2.5 rounded bg-[rgba(130,179,96,0.16)]">
                  <div className="text-[#275F00] text-center text-xs font-semibold leading-4 tracking-[0.24px] uppercase">
                    COMPLETED
                  </div>
                </div>
                <div className="text-[#18181B] text-right text-sm font-semibold leading-5">
            ...
            <div className="flex h-[76px] px-3 items-center gap-3 self-stretch">
              <div className="flex w-11 h-11 p-[11px] justify-center items-center rounded-full bg-[#E4E4E7]">
                <svg width="22" height="22" viewBox="0 0 22 22" fill="none">
                  <path
                    d="M3.98458 18.08L18.6911 11.776C18.8431 11.7113 18.9727 11.6033 19.0638 11.4654C19.155 11.3275 19.2035 11.1659 19.2035 11.0007C19.2035 10.8354 19.155 10.6738 19.0638 10.536C18.9727 10.3981 18.8431 10.2901 18.6911 10.2253L3.98458 3.92136C3.85723 3.86581 3.71807 3.84284 3.57963 3.85453C3.44119 3.86621 3.30784 3.91217 3.19161 3.98827C3.07537 4.06436 2.97991 4.1682 2.91383 4.29041C2.84775 4.41262 2.81314 4.54935 2.81312 4.68828L2.80469 8.57349C2.80469 8.99488 3.11652 9.35727 3.5379 9.40784L15.4464 11.0007L3.5379 12.5851C3.11652 12.6441 2.80469 13.0065 2.80469 13.4279L2.81312 17.3131C2.81312 17.9115 3.42834 18.3244 3.98458 18.08Z"
                    fill="#18181B"
                  />
                </svg>
              </div>
            ...
            <div className="flex h-[76px] px-3 items-center gap-[18px] self-stretch">
              <div className="flex items-center gap-5 flex-1">
                <div className="w-11 h-11 rounded-full bg-[#E4E4E7] relative flex items-center justify-center">
                  ...
                  <svg width="22" height="22" viewBox="0 0 22 22" fill="none">
                    <path
                      d="M13.8484 3.40391H5.29844V18.6039H16.6984V6.25391H13.8484V3.40391ZM5.29844 1.50391H14.7984L18.5984 5.30391V18.6039C18.5984 19.1078 18.3983 19.5911 18.0419 19.9474C17.6856 20.3037 17.2023 20.5039 16.6984 20.5039H5.29844C4.79453 20.5039 4.31125 20.3037 3.95493 19.9474C3.59862 19.5911 3.39844 19.1078 3.39844 18.6039V3.40391C3.39844 2.89999 3.59862 2.41672 3.95493 2.0604C4.31125 1.70408 4.79453 1.50391 5.29844 1.50391ZM7.19844 10.0539H14.7984V11.9539H7.19844V10.0539ZM7.19844 13.8539H14.7984V15.7539H7.19844V13.8539Z"
                      fill="#18181B"
                    />
                  </svg>
                  {/* UK Flag Circle */}
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 md:p-4">
          <div className="bg-white w-full h-full md:h-auto md:rounded-lg md:max-w-sm md:mx-auto flex flex-col">
            ...
            <div className="flex items-center gap-3 p-4 flex-shrink-0">
              ...
              {/* Title */}
              <h2 className="flex-1 text-[#18181B] text-lg font-semibold uppercase tracking-wider">
                DEPOSIT CRYPTO
              </h2>
            ...
            <div className="px-4 pb-4">
              <p className="text-[#51525C] text-sm font-medium uppercase">
                Select the Crypto you'd like to send and the fiat you'd like it
                to be deposited into your account as.
              </p>
            </div>
            ...
            <div className="flex-1 px-4 pb-6 flex flex-col gap-6">
              ...
              <div className="flex flex-col gap-4 p-5 rounded-lg bg-[#F4F4F5]">
                <div className="text-[#51525C] text-xs font-medium uppercase">
                  YOU SEND
                </div>
                ...
                <div className="flex flex-col gap-2">
                  <div className="flex items-center gap-3">
                    ...
                    <div
                      ...
                      onClick={() =>
                        setShowCryptoSendDropdown(!showCryptoSendDropdown)
                      }
                    >
                      <div className="flex items-center gap-2 sm:gap-1">
                        ...
                        <span className="text-[#18181B] text-xl font-medium">
                          BTC
                        </span>
                      </div>
                      <svg
                ...
                <div className="flex flex-col gap-2">
                  <div className="flex items-center gap-3">
                    ...
                    <div
                      className="flex items-center gap-2 cursor-pointer"
                      onClick={() =>
                        setShowCryptoReceiveDropdown(!showCryptoReceiveDropdown)
                      }
                    >
                      <div className="flex items-center gap-2 w-auto flex-grow-0 sm:w-full sm:flex-grow">
                        <img
                          src="https://cdn.builder.io/api/v1/image/assets%2F83d02907b4ae4e20b4c5791e73e38dc8%2Ff409584c4f6a438baa5e45015acad850?format=webp&width=800"
                          alt="US Flag"
                          width="24"
                          height="24"
                      ...
                      <svg
                        ...
                        viewBox="0 0 24 24"
                        fill="none"
                        className={`transition-transform ${showCryptoReceiveDropdown ? "rotate-180" : ""}`}
                      >
                        <path
                          d="M6.17864 8.70073C6.38017 8.4992 6.63666 8.39844 6.94811 8.39844C7.25956 8.39844 7.51604 8.4992 7.71757 8.70073L12.0046 12.9877L16.2916 8.70073C16.4931 8.4992 16.7496 8.39844 17.0611 8.39844C17.3725 8.39844 17.629 8.4992 17.8305 8.70073C18.032 8.90225 18.1328 9.15874 18.1328 9.47019C18.1328 9.78164 18.032 10.0381 17.8305 10.2397L12.774 15.2961C12.6641 15.4061 12.545 15.4841 12.4168 15.5303C12.2886 15.5764 12.1511 15.5992 12.0046 15.5984C11.858 15.5984 11.7206 15.5753 11.5924 15.5292C11.4641 15.483 11.345 15.4053 11.2351 15.2961L6.17864 10.2397C5.97712 10.0381 5.87635 9.78164 5.87635 9.47019C5.87635 9.15874 5.97712 8.90225 6.17864 8.70073Z"
                          fill="#18181B"
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        handleCryptoReceiveChange(e.target.value)
                      }
                      placeholder="0.00"
                      className="text-[#18181B] text-right text-[36px] font-medium bg-transparent border-none outline-none w-48"
                    />
              ...
              <div className="flex items-center justify-center gap-2 p-2 rounded-md bg-[#F4F4F5]">
                <svg width="20" height="20" viewBox="0 0 21 20" fill="none">
                  <path
                    d="M10.5 2.5C14.6422 2.5 18 5.85787 18 10C18 14.1422 14.6422 17.5 10.5 17.5C6.35787 17.5 3 14.1422 3 10C3 5.85787 6.35787 2.5 10.5 2.5Z"
                    stroke="#18181B"
                    strokeOpacity="0.3"
                    strokeWidth="1.66667"
                    strokeLinecap="round"
                  />
                  <path
                    d="M10.5 2.5C14.6422 2.5 18 5.85787 18 10"
                    stroke="#18181B"
                    strokeWidth="1.66667"
                    strokeLinecap="round"
                  />
      ...
      {showTransferOverlay && (
        <div className="fixed inset-0 bg-white flex flex-col z-50">
          ...
          <div className="flex justify-between items-center p-4 flex-shrink-0">
            <h2 className="text-[#18181B] text-lg font-semibold uppercase tracking-wider">
              TRANSFER
            </h2>
            <button
          ...
          <div className="flex-1 px-4 pb-6 flex flex-col gap-6">
              ...
              <div className="flex flex-col gap-2">
                <div className="flex items-center gap-3">
                  ...
                  <div
                    className="flex items-center gap-2 cursor-pointer"
                    onClick={() =>
                      setShowTransferCurrencyDropdown(
                        !showTransferCurrencyDropdown,
                      )
                    }
                  >
                    <div className="flex items-center gap-2">
                      <svg
                        ...
                        fill="none"
                      >
                        <g clipPath="url(#clip0_16461_17730)">
                          <mask
                            id="mask0_16461_17730"
                    ...
                    <svg
                      ...
                      viewBox="0 0 24 24"
                      fill="none"
                      className={`transition-transform ${showTransferCurrencyDropdown ? "rotate-180" : ""}`}
                    >
                      <path
                        d="M6.17864 8.70073C6.38017 8.4992 6.63666 8.39844 6.94811 8.39844C7.25956 8.39844 7.51604 8.4992 7.71757 8.70073L12.0046 12.9877L16.2916 8.70073C16.4931 8.4992 16.7496 8.39844 17.0611 8.39844C17.3725 8.39844 17.629 8.4992 17.8305 8.70073C18.032 8.90225 18.1328 9.15874 18.1328 9.47019C18.1328 9.78164 18.032 10.0381 17.8305 10.2397L12.774 15.2961C12.6641 15.4061 12.545 15.4841 12.4168 15.5303C12.2886 15.5764 12.1511 15.5992 12.0046 15.5984C11.858 15.5984 11.7206 15.5753 11.5924 15.5292C11.4641 15.483 11.345 15.4053 11.2351 15.2961L6.17864 10.2397C5.97712 10.0381 5.87635 9.78164 5.87635 9.47019C5.87635 9.15874 5.97712 8.90225 6.17864 8.70073Z"
                        fill="#18181B"
                  ...
                  <div className="flex-1 flex justify-end items-center relative">
                    ...
                    />
                    {/* MAX Button */}
                    <div className="absolute -top-[18px] right-4 flex px-1.5 py-1 justify-center items-center rounded-sm bg-[#E4E4E7]">
                      <span className="text-[#51525C] text-center text-[10px] font-semibold uppercase tracking-wide">
                        MAX
                      </span>
                    </div>
                  </div>
                ...
                <div className="flex justify-between items-center">
                  ...
                  <div className="text-[#51525C] text-xs font-medium">
                    €2,050,328.13
                  </div>
                </div>
              </div>
            ...
            <div className="flex flex-col gap-2">
              ...
              <div className="flex h-[52px] px-4 items-center rounded-lg border border-[#D1D1D6] bg-white">
                <input
                  type="email"
                  value={transferEmailAddress}
                  onChange={(e) => setTransferEmailAddress(e.target.value)}
                  placeholder="Enter email address"
                  className="flex-1 text-[#18181B] text-sm font-medium bg-transparent border-none outline-none uppercase"
                />
              </div>
            </div>
            ...
            <div className="flex flex-col gap-2">
              ...
              <div className="flex h-[52px] px-4 items-center rounded-lg bg-[#F4F4F5]">
                <input
                  type="text"
                  value={transferReference}
                  onChange={(e) => setTransferReference(e.target.value)}
                  placeholder="Enter your reference"
                  className="flex-1 text-[#70707B] text-sm font-medium bg-transparent border-none outline-none uppercase"
                />
              </div>
            </div>
          </div>
          ...
          <div className="p-4 pt-0">
            <button
              className={`w-full py-3 px-8 rounded-lg transition-all ${
                transferAmount && transferEmailAddress
                  ? "bg-[#18181B] cursor-pointer hover:bg-[#2A2A2A]"
                  : "bg-[#3F3F46] opacity-50 cursor-not-allowed"
              }`}
              disabled={!transferAmount || !transferEmailAddress}
            >
              <span className="text-white text-sm font-semibold uppercase">
                CONTINUE
              </span>
      ...
      {showMoreDropdown && (
        <>
          ...
          >
            ...
            >
              <span className="text-[#18181B] text-sm font-medium uppercase tracking-wide">
                FX
              </span>
            </div>
            ...
            >
              <span className="text-[#51525C] text-sm font-medium uppercase tracking-wide">
                MERCHANT
              </span>
            </div>
      ...
      {/* Bottom Navigation */}
      <div className="fixed bottom-0 left-0 right-0 flex w-full h-[70px] p-1.5 items-center justify-between border-t border-[#E4E4E7] bg-white z-40">
        {/* Home */}
        ...
        >
          <svg width="24" height="24" viewBox="0 0 25 24" fill="none">
            <path
              d="M19.1016 20H5.10156C4.57113 20 4.06242 19.7893 3.68735 19.4142C3.31228 19.0391 3.10156 18.5304 3.10156 18V9C3.10156 8.46957 3.31228 7.96086 3.68735 7.58579C4.06242 7.21071 4.57113 7 5.10156 7H19.1016C19.632 7 20.1407 7.21071 20.5158 7.58579C20.8908 7.96086 21.1016 8.46957 21.1016 9V18C21.1016 18.5304 20.8908 19.0391 20.5158 19.4142C20.1407 19.7893 19.632 20 19.1016 20Z"
              stroke="#51525C"
              strokeWidth="1.8"
            />
            <path
              d="M16.6016 14C16.469 14 16.3418 13.9473 16.248 13.8536C16.1542 13.7598 16.1016 13.6326 16.1016 13.5C16.1016 13.3674 16.1542 13.2402 16.248 13.1464C16.3418 13.0527 16.469 13 16.6016 13C16.7342 13 16.8613 13.0527 16.9551 13.1464C17.0489 13.2402 17.1016 13.3674 17.1016 13.5C17.1016 13.6326 17.0489 13.7598 16.9551 13.8536C16.8613 13.9473 16.7342 14 16.6016 14Z"
              fill="#51525C"
              stroke="#51525C"
              strokeWidth="1.8"
              strokeLinecap="round"
        ...
        >
          <svg width="24" height="24" viewBox="0 0 25 24" fill="none">
            <path
              d="M7 10H5V17H7V10ZM13 10H11V17H13V10ZM21.5 19H2.5V21H21.5V19ZM19 10H17V17H19V10ZM12 3.26L17.21 6H6.79L12 3.26ZM12 1L2.5 6V8H21.5V6L12 1Z"
              fill="#51525C"
            />
          </svg>
        </button>
        ...
        >
          <svg width="24" height="24" viewBox="0 0 25 24" fill="none">
            <path
              d="M5.17225 16.0596C6.0183 17.7701 7.39045 19.1644 9.08725 20.0376C10.7719 20.9026 12.6926 21.1947 14.5583 20.8696C16.4297 20.5406 18.1442 19.6144 19.4452 18.2296C20.7584 16.8318 21.5944 15.0536 21.8333 13.1506C22.0759 11.2433 21.7105 9.30815 20.7892 7.62061C19.8766 5.94593 18.4502 4.60861 16.7203 3.80561C15.0019 3.00978 13.0709 2.79631 11.2203 3.19761C9.37025 3.59861 7.85425 4.51061 6.60025 5.95261C6.44925 6.11261 5.86525 6.75861 5.38025 7.73361M8.40625 7.99961L4.79725 8.71961L3.90625 4.99961M12.9062 8.99961V12.9996L15.9062 14.9996"
              stroke="#51525C"
              strokeWidth="2"
              strokeLinecap="round"
              strokeLinejoin="round"
        ...
        >
          <svg width="24" height="24" viewBox="0 0 25 24" fill="none">
            <path
              d="M12.3047 10C14.5138 10 16.3047 8.20914 16.3047 6C16.3047 3.79086 14.5138 2 12.3047 2C10.0955 2 8.30469 3.79086 8.30469 6C8.30469 8.20914 10.0955 10 12.3047 10Z"
              stroke="#51525C"
              strokeWidth="1.8"
            />
            <path
              d="M20.3047 17.5C20.3047 19.985 20.3047 22 12.3047 22C4.30469 22 4.30469 19.985 4.30469 17.5C4.30469 15.015 7.88669 13 12.3047 13C16.7227 13 20.3047 15.015 20.3047 17.5Z"
              stroke="#51525C"
              strokeWidth="1.8"
            />
          </svg>
            ...
            <div className="flex-1 p-4 space-y-1 flex flex-col justify-start items-start md:justify-center md:items-center">
              ...
              >
                ...
                <div className="flex flex-col items-center gap-1">
                  ...
                  <p className="text-[#51525C] text-center text-xs font-medium uppercase">
                    DEPOSIT VIA CRYPTO OF YOUR CHOICE.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="bg-white w-full h-full md:h-auto md:rounded-lg md:max-w-sm md:mx-auto flex flex-col">
            ...
            <div className="flex-1 p-4 flex flex-col justify-start items-start gap-8 md:justify-center md:items-center">
                  ...
                  <>
                    ...
                    <div className="absolute top-full mt-1 w-full z-50 flex flex-col rounded-lg border border-[#E4E4E7] bg-white shadow-[0_4px_12px_0_rgba(0,0,0,0.12)] overflow-hidden">
                      ...
                      >
                        ...
                        <span className="flex-1 text-[#18181B] text-sm font-medium uppercase truncate">
                          AMERICAN DOLLAR (USD)
                        </span>
                        {hasCurrencyBeenSelected &&
                          selectedCurrency === "AMERICAN DOLLAR (USD)" && (
                            <svg
                              width="24"
                              height="24"
                            ...
                            >
                              <path
                                d="M3.60156 11.9984L9.20156 17.5984L20.4016 6.39844"
                                stroke="#18181B"
                                strokeWidth="2.28"
                                strokeLinecap="round"
                                strokeLinejoin="round"
                      ...
                      >
                        ...
                        >
                          <g clipPath="url(#clip0_aed)">
                            ...
                            />
                            <path
                              d="M6.78125 16.1758L7.82473 23.2556C9.12467 23.738 10.5308 24.0019 11.9986 24.0019C17.1582 24.0019 21.5567 20.7454 23.2522 16.1758H6.78125Z"
                              fill="#18181B"
                            />
                            <path
                              d="M6.78125 7.82611L7.82473 0.746297C9.12467 0.263906 10.5308 0 11.9986 0C17.1582 0 21.5567 3.2565 23.2522 7.82611H6.78125Z"
                              fill="#6DA544"
                            />
                            <path
              ...
              <div className="flex p-3 items-center gap-2 w-full rounded-md bg-[rgba(170,170,187,0.12)]">
                ...
                <div className="flex flex-col justify-center items-start gap-0.5 flex-1">
                  <p className="text-[#18181B] text-xs font-semibold uppercase">
                    IT CAN TAKE UP TO 5 DAYS TO DEPOSIT.
                  </p>
                </div>
              </div>
            </div>
              ...
              <div className="flex flex-col items-start gap-6 w-full">
                <div className="flex flex-col items-start gap-2 w-full relative">
                  ...
                  <div
                    ...
                    onClick={() =>
                      setShowIbanCurrencyDropdown(!showIbanCurrencyDropdown)
                    }
                  >
                ...
                {/* Instructions */}
                <p className="text-[#51525C] text-sm font-medium uppercase">
                  TO DEPOSIT FUNDS PLEASE USE THIS IBAN NUMBER.
                </p>
              </div>
                ...
                <div className="flex items-center gap-2 w-full">
                  ...
                  <button className="w-6 h-6 flex items-center justify-center">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
                      ...
                      />
                      <path
                        d="M15.8785 6.78906H4.33153C3.9783 6.78931 3.63962 6.92981 3.38994 7.17967C3.14025 7.42953 3 7.76831 3 8.12154V19.6671C3 20.0205 3.14039 20.3594 3.39027 20.6093C3.64016 20.8592 3.97908 20.9996 4.33247 20.9996H15.8785C16.2318 20.9995 16.5705 20.8591 16.8203 20.6093C17.07 20.3595 17.2104 20.0208 17.2105 19.6676V8.12059C17.2103 7.76744 17.0698 7.42884 16.8201 7.17917C16.5703 6.9295 16.2317 6.78919 15.8785 6.78906Z"
                        stroke="#1A8A7E"
                        strokeWidth="1.68"
                        strokeLinejoin="round"
                      />
          ...
          <div className="bg-white w-full h-full md:h-auto md:rounded-lg md:max-w-sm md:mx-auto flex flex-col max-h-screen overflow-hidden">
            ...
            <div className="flex h-11 items-start gap-1.5 p-4 flex-shrink-0">
              <div className="flex h-11 p-0.5 items-center flex-1 rounded-lg bg-[#F4F4F5] backdrop-blur-[12px]">
                ...
                >
                  <span
                    className={`text-center text-sm font-semibold leading-normal tracking-[0.14px] uppercase ${
                      withdrawalTab === "new"
                        ? "text-[#18181B]"
                        : "text-[#51525C]"
                    }`}
                ...
                >
                  <span
                    className={`text-center text-sm font-medium leading-normal tracking-[0.14px] uppercase ${
                      withdrawalTab === "saved"
                        ? "text-[#18181B]"
                        : "text-[#51525C]"
                    }`}
                ...
                <div className="flex flex-col gap-4 p-5 rounded-lg bg-[#F4F4F5] relative">
                  ...
                  <div className="flex flex-col gap-2">
                    <div className="flex items-center gap-3">
                      ...
                      <div className="flex items-center gap-2 self-stretch relative">
                        <div
                          ...
                          onClick={() =>
                            setShowWithdrawalCurrencyDropdown(
                              !showWithdrawalCurrencyDropdown,
                            )
                          }
                        >
                          <div className="flex items-center gap-2">
                    ...
                    <div className="flex items-start gap-2 self-stretch">
                      <div className="flex-1 text-[#51525C] text-xs font-medium uppercase">
                        EURO
                      </div>
                      <div className="flex-1 text-[#51525C] text-right text-xs font-medium uppercase">
                        €2,050,328.13
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="absolute right-4 top-5 flex px-1.5 py-1 justify-center items-center gap-2.5 rounded bg-[#E4E4E7]">
                    <span className="text-[#51525C] text-center text-[10px] font-semibold leading-normal tracking-[0.1px] uppercase">
                      MAX
                    </span>
                  </div>
                </div>
                      ...
                      <div className="flex p-6 flex-col items-center gap-3 self-stretch rounded-lg border border-dashed border-[#A0A0AB] bg-[#FCFCFC]">
                        <div className="flex flex-col items-center gap-1">
                          <div className="flex justify-center items-start gap-1 self-stretch">
                            <span className="text-[#18181B] text-xs font-semibold uppercase">
                              Click to upload
                            </span>
                            <span className="text-[#51525C] text-xs font-medium uppercase">
                              or drag and drop
                            </span>
                          </div>
                          <span className="text-[#51525C] text-xs font-medium uppercase">
                    ...
                    <div className="flex flex-col gap-2">
                      ...
                      <div className="flex p-3 flex-col justify-center items-start gap-3 self-stretch rounded-lg border border-[#D1D1D6] bg-white">
                        <div className="flex items-center gap-2 self-stretch">
                          <div className="flex flex-col items-start flex-1 self-stretch">
                            <span className="text-[#18181B] text-sm font-medium leading-5 uppercase">
                              Project_Specifications_2023.pdf
                            </span>
                            <span className="text-[#51525C] text-xs font-medium leading-4 uppercase">
                              512 KB
                            </span>
                          </div>
                        </div>
                      ...
                      <div className="flex p-3 flex-col justify-center items-start gap-3 self-stretch rounded-lg border border-[#D1D1D6] bg-white">
                        <div className="flex items-center gap-2 self-stretch">
                          <div className="flex flex-col items-start flex-1 self-stretch">
                            <span className="text-[#18181B] text-sm font-medium leading-5 uppercase">
                              System_Architecture_Overvie...pdf
                            </span>
                            <span className="text-[#51525C] text-xs font-medium leading-4 uppercase">
                              1.5 MB
                            </span>
      ...
      {/* Third-Party Payment Overlay */}
      {showThirdPartyPaymentOverlay && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 md:p-4">
          <div className="bg-white w-full h-full md:h-auto md:rounded-lg md:max-w-sm md:mx-auto flex flex-col max-h-screen overflow-hidden">
            {/* Header */}
            <div className="flex items-center justify-between p-4 flex-shrink-0 border-b border-[#D1D1D6]">
              ...
              <button
                onClick={() => setShowThirdPartyPaymentOverlay(false)}
                className="w-6 h-6 flex items-center justify-center"
              >
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
                  <path
            ...
            <div className="flex h-11 items-start gap-1.5 p-4 flex-shrink-0">
              <div className="flex h-11 p-0.5 items-center flex-1 rounded-lg bg-[#F4F4F5] backdrop-blur-[12px]">
                <button
                  className={`flex px-[18px] py-1.5 justify-center items-center gap-2.5 flex-1 self-stretch rounded-[7px] ${
                    thirdPartyPaymentTab === "new"
                      ? "border border-black/[0.04] bg-[#FCFCFC] shadow-[0_3px_8px_0_rgba(0,0,0,0.12),0_3px_1px_0_rgba(0,0,0,0.04)]"
                      : ""
                  }`}
                  onClick={() => setThirdPartyPaymentTab("new")}
                >
                  <span
                    className={`text-center text-sm font-semibold leading-normal tracking-[0.14px] uppercase ${
                      thirdPartyPaymentTab === "new"
                ...
                <button
                  className={`flex px-[18px] py-1.5 justify-center items-center gap-2.5 flex-1 self-stretch rounded-[7px] ${
                    thirdPartyPaymentTab === "saved"
                      ? "border border-black/[0.04] bg-[#FCFCFC] shadow-[0_3px_8px_0_rgba(0,0,0,0.12),0_3px_1px_0_rgba(0,0,0,0.04)]"
                      : ""
                  }`}
                  onClick={() => setThirdPartyPaymentTab("saved")}
                >
                  <span
                    className={`text-center text-sm font-medium leading-normal tracking-[0.14px] uppercase ${
                      thirdPartyPaymentTab === "saved"
                ...
                <div className="flex flex-col gap-4 p-5 rounded-lg bg-[#F4F4F5] relative">
                  ...
                  <div className="flex flex-col gap-2">
                    <div className="flex items-center gap-3">
                        ...
                        >
                          <div className="flex items-center gap-2">
                            <svg
                              ...
                              fill="none"
                            >
                              <g clipPath="url(#clip0_eur_thirdparty)">
                                <mask
                                  id="mask0_eur_thirdparty"
                                  style={{ maskType: "luminance" }}
                                  maskUnits="userSpaceOnUse"
                                  x="0"
                                  y="0"
                                ...
                                <g mask="url(#mask0_eur_thirdparty)">
                                  <path d="M0 0H24V24H0V0Z" fill="#0052B4" />
                                  <path
                                    d="M11.9984 4.69531L12.3875 5.89062H13.6391L12.6219 6.62656L13.0109 7.82656L11.9937 7.08594L10.9766 7.82656L11.3656 6.62656L10.3484 5.89062H11.6047L11.9984 4.69531ZM6.83281 6.83281L7.95781 7.40469L8.84375 6.51406L8.64688 7.75625L9.76719 8.32812L8.525 8.525L8.32812 9.76719L7.75625 8.64219L6.51406 8.84375L7.40469 7.95312L6.83281 6.83281ZM4.69531 11.9984L5.89062 11.6094V10.3578L6.62656 11.375L7.82656 10.9859L7.08594 12.0031L7.82656 13.0203L6.62656 12.6313L5.89062 13.6484V12.3922L4.69531 11.9984ZM6.83281 17.1641L7.40469 16.0391L6.51406 15.1531L7.75625 15.35L8.32812 14.2297L8.525 15.4719L9.76719 15.6687L8.64219 16.2406L8.84375 17.4828L7.95312 16.5922L6.83281 17.1641ZM11.9984 19.3016L11.6094 18.1062H10.3578L11.375 17.3703L10.9859 16.1703L12.0031 16.9109L13.0203 16.1703L12.6313 17.3703L13.6484 18.1062H12.3922L11.9984 19.3016ZM17.1641 17.1641L16.0391 16.5922L15.1531 17.4828L15.35 16.2406L14.2297 15.6687L15.4719 15.4719L15.6687 14.2297L16.2406 15.3547L17.4828 15.1531L16.5922 16.0437L17.1641 17.1641ZM19.3016 11.9984L18.1062 12.3875V13.6391L17.3703 12.6219L16.1703 13.0109L16.9109 11.9937L16.1703 10.9766L17.3703 11.3656L18.1062 10.3484V11.6047L19.3016 11.9984ZM17.1641 6.83281L16.5922 7.95781L17.4828 8.84375L16.2406 8.64688L15.6687 9.76719L15.4719 8.525L14.2297 8.32812L15.3547 7.75625L15.1531 6.51406L16.0437 7.40469L17.1641 6.83281Z"
                                    fill="#FFDA44"
                              ...
                              <defs>
                                <clipPath id="clip0_eur_thirdparty">
                                  <rect width="24" height="24" fill="white" />
                                </clipPath>
                              </defs>
                            </svg>
                          ...
                          <svg
                            ...
                            viewBox="0 0 24 24"
                            fill="none"
                            className={`transition-transform ${showThirdPartyPaymentCurrencyDropdown ? "rotate-180" : "rotate-90"}`}
                          >
                            <path
                              d="M6.17864 8.70073C6.38017 8.4992 6.63666 8.39844 6.94811 8.39844C7.25956 8.39844 7.51604 8.4992 7.71757 8.70073L12.0046 12.9877L16.2916 8.70073C16.4931 8.4992 16.7496 8.39844 17.0611 8.39844C17.3725 8.39844 17.629 8.4992 17.8305 8.70073C18.032 8.90225 18.1328 9.15874 18.1328 9.47019C18.1328 9.78164 18.032 10.0381 17.8305 10.2397L12.774 15.2961C12.6641 15.4061 12.545 15.4841 12.4168 15.5303C12.2886 15.5764 12.1511 15.5992 12.0046 15.5984C11.858 15.5984 11.7206 15.5753 11.5924 15.5292C11.4641 15.483 11.345 15.4053 11.2351 15.2961L6.17864 10.2397C5.97712 10.0381 5.87635 9.78164 5.87635 9.47019C5.87635 9.15874 5.97712 8.90225 6.17864 8.70073Z"
                              fill="#18181B"
                      ...
                      <input
                        type="number"
                        value={thirdPartyPaymentAmount}
                        onChange={(e) =>
                          setThirdPartyPaymentAmount(e.target.value)
                        }
                        placeholder="900.00"
                        className="text-[#18181B] text-right text-[28px] font-medium bg-transparent border-none outline-none w-32"
                      />
              ...
              <div className="flex flex-col items-center gap-6 h-full">
                ...
                <div className="flex flex-col items-start gap-4 self-stretch">
                  <div className="flex p-5 flex-col items-start gap-4 self-stretch rounded-lg bg-[#F4F4F5] relative">
                    <div className="self-stretch text-[#51525C] text-xs font-medium uppercase">
                      FROM
                    </div>
                    ...
                    <div className="flex flex-col items-start gap-2 self-stretch">
                      <div className="flex h-[30px] items-center gap-3 self-stretch">
                        <div
                          ...
                          onClick={() =>
                            setShowFxFromDropdown(!showFxFromDropdown)
                          }
                        >
                          <div className="flex items-center gap-2">
                            <svg
                ...
                <div className="absolute left-1/2 top-1/2 transform -translate-x-1/2 -translate-y-1/2 z-10">
                  <div
                    className="flex w-9 h-9 p-[7.2px] justify-center items-center rounded-lg bg-[#18181B] cursor-pointer"
                    onClick={() => {
                  ...
                  >
                    <svg width="22" height="22" viewBox="0 0 22 22" fill="none">
                      <path
                        d="M11 5.59766L6.5 10.0977H15.5L11 5.59766ZM6.5 11.8977L11 16.3977L15.5 11.8977H6.5Z"
                        fill="white"
                      />
                    </svg>
                  </div>
                ...
                <div className="flex p-2 justify-center items-center gap-2 self-stretch rounded bg-[#F4F4F5]">
                  ...
                  >
                    <path
                      d="M10 2.5C14.1422 2.5 17.5 5.85787 17.5 10C17.5 14.1422 14.1422 17.5 10 17.5C5.85787 17.5 2.5 14.1422 2.5 10C2.5 5.85787 5.85787 2.5 10 2.5Z"
                      stroke="#18181B"
                      strokeOpacity="0.3"
                      strokeWidth="1.66667"
                      strokeLinecap="round"
                    />
                    <path
                      d="M10 2.5C14.1422 2.5 17.5 5.85787 17.5 10"
                      stroke="#18181B"
                      strokeWidth="1.66667"
                      strokeLinecap="round"
                    />
                  </svg>
                  <span className="text-[#18181B] text-center text-sm font-medium">
                    {fxExchangeRate}
                  </span>
                </div>
              ...
              <div className="flex flex-col items-start gap-2 self-stretch">
                ...
                <div
                  className={`flex p-3 items-center gap-3 self-stretch rounded-lg border cursor-pointer transition-colors ${
                    ...
                    "Olympic Casino Tallinn - Cash Transfers"
                      ? "border-[#18181B]"
                      : "border-[#D1D1D6] hover:border-[#51525C]"
                  }`}
                  onClick={() =>
                    setSelectedMerchant(
                      "Olympic Casino Tallinn - Cash Transfers",
                ...
                <div
                  className={`flex p-3 items-center gap-3 self-stretch rounded-lg border cursor-pointer transition-colors ${
                    selectedMerchant === "Potromaso Casino"
                      ? "border-[#18181B]"
                      : "border-[#D1D1D6] hover:border-[#51525C]"
                  }`}
                ...
                <div
                  className={`flex p-3 items-center gap-3 self-stretch rounded-lg border cursor-pointer transition-colors ${
                    selectedMerchant ===
                    "Olympic Casino Tallinn - Cash Transfers 2"
                      ? "border-[#18181B]"
                      : "border-[#D1D1D6] hover:border-[#51525C]"
                  }`}
                  onClick={() =>
                ...
                <div
                  className={`flex p-3 items-center gap-3 self-stretch rounded-lg border cursor-pointer transition-colors ${
                    selectedMerchant === "Potromaso Casino 2"
                      ? "border-[#18181B]"
                      : "border-[#D1D1D6] hover:border-[#51525C]"
                  }`}
                ...
                <div
                  className={`flex p-3 items-center gap-3 self-stretch rounded-lg border cursor-pointer transition-colors ${
                    selectedMerchant ===
                    "Olympic Casino Tallinn - Cash Transfers 3"
                      ? "border-[#18181B]"
                      : "border-[#D1D1D6] hover:border-[#51525C]"
                  }`}
                  onClick={() =>
                ...
                <div
                  className={`flex p-3 items-center gap-3 self-stretch rounded-lg border cursor-pointer transition-colors ${
                    selectedMerchant === "Potromaso Casino 3"
                      ? "border-[#18181B]"
                      : "border-[#D1D1D6] hover:border-[#51525C]"
                  }`}
                ...
                <div
                  className={`flex p-3 items-center gap-3 self-stretch rounded-lg border cursor-pointer transition-colors ${
                    selectedMerchant ===
                    "Olympic Casino Tallinn - Cash Transfers 4"
                      ? "border-[#18181B]"
                      : "border-[#D1D1D6] hover:border-[#51525C]"
                  }`}
                  onClick={() =>
