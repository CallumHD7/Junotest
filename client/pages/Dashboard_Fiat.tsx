      ...
      <div className="w-full h-[606px] relative overflow-hidden">
        ...
        <div className="absolute bottom-0 left-0 w-full flex flex-col items-center gap-2.5 px-3 pb-[40px]">
          <div className="flex items-center gap-3">
            ...
            {/* TRANSFER */}
            <div className="flex flex-col items-center gap-2.5 cursor-pointer" onClick={() => setShowTransferOverlay(true)}>
              <div className="w-[60px] h-[60px] rounded-lg bg-[#E4E4E7] flex items-center justify-center p-2 backdrop-blur-[12px]">
                <img
            ...
            <div className="flex flex-col items-center gap-2.5 cursor-pointer relative" onClick={() => setShowMoreDropdown(!showMoreDropdown)}>
              ...
              {showMoreDropdown && (
                <>
                  ...
                  {/* Dropdown Menu */}
                  <div className="absolute top-full mt-2 left-1/2 transform -translate-x-1/2 sm:left-1/2 sm:transform sm:-translate-x-1/2 max-sm:left-[-20px] max-sm:transform-none z-50 flex flex-col w-40 rounded-lg border border-[#E4E4E7] bg-white shadow-[0_5px_14px_0_rgba(0,0,0,0.15)] overflow-hidden">
                    {/* FX Option */}
                    <div
      ...
      {showTransferOverlay && (
        <div className="fixed inset-0 bg-white flex flex-col z-50">
          ...
          <div className="flex justify-between items-center p-4 flex-shrink-0">
            <h2 className="text-[#18181B] text-lg font-semibold uppercase tracking-wider">TRANSFER</h2>
            <button
          ...
          <div className="flex-1 px-4 pb-6 flex flex-col gap-6">
            {/* Currency Section */}
            <div className="flex flex-col gap-4 p-5 rounded-lg bg-[#F4F4F5]">
              <div className="text-[#51525C] text-xs font-medium uppercase">CURRENCY</div>
              ...
              <div className="flex flex-col gap-2">
                <div className="flex items-center gap-3">
                  ...
                  <div
                    className="flex items-center gap-2 cursor-pointer"
                    onClick={() => setShowTransferCurrencyDropdown(!showTransferCurrencyDropdown)}
                  >
                    <div className="flex items-center gap-2">
                      <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
                        <g clipPath="url(#clip0_16461_17730)">
                          <mask id="mask0_16461_17730" style={{maskType:"luminance"}} maskUnits="userSpaceOnUse" x="0" y="0" width="24" height="24">
            ...
            <div className="flex flex-col gap-2">
              <div className="text-[#51525C] text-xs font-medium uppercase">EMAIL ADDRESS</div>
            ...
            {/* Reference Section */}
            <div className="flex flex-col gap-2">
              <div className="text-[#51525C] text-xs font-medium uppercase">REFERENCE</div>
      ...
      {showThirdPartyPaymentOverlay && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 md:p-4">
          <div className="bg-white w-full h-full md:h-auto md:rounded-lg md:max-w-sm md:mx-auto flex flex-col max-h-screen overflow-hidden">
            {/* Header */}
            <div className="flex items-center justify-between p-4 flex-shrink-0 border-b border-[#D1D1D6]">
              <h2 className="text-[#18181B] text-lg font-semibold uppercase tracking-wider">THIRD-PARTY PAYMENT</h2>
              <button
            ...
            <div className="flex h-11 items-start gap-1.5 p-4 flex-shrink-0">
              <div className="flex h-11 p-0.5 items-center flex-1 rounded-lg bg-[#F4F4F5] backdrop-blur-[12px]">
                ...
                >
                  <span className={`text-center text-sm font-semibold leading-normal tracking-[0.14px] uppercase ${
                    thirdPartyPaymentTab === "new" ? 'text-[#18181B]' : 'text-[#51525C]'
                  }`}>
                    New Account
                  </span>
                </button>
                ...
                >
                  <span className={`text-center text-sm font-medium leading-normal tracking-[0.14px] uppercase ${
                    thirdPartyPaymentTab === "saved" ? 'text-[#18181B]' : 'text-[#51525C]'
                  }`}>
                    Saved Accounts
                  </span>
                </button>
            ...
            <div className="flex-1 px-4 pb-6 overflow-y-auto">
              <div className="flex flex-col gap-6">
                {/* Pay With Section */}
                <div className="flex flex-col gap-4 p-5 rounded-lg bg-[#F4F4F5] relative">
                  <div className="text-[#51525C] text-xs font-medium uppercase">PAY WITH</div>
                  ...
                  <div className="flex flex-col gap-2">
                    <div className="flex items-center gap-3">
                      ...
                      <div className="flex items-center gap-2 self-stretch relative">
                        <div
                          className="flex items-center gap-1 cursor-pointer"
                          onClick={() => setShowThirdPartyPaymentCurrencyDropdown(!showThirdPartyPaymentCurrencyDropdown)}
                        >
                          <div className="flex items-center gap-2">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
                              <g clipPath="url(#clip0_eur_thirdparty)">
                                <mask id="mask0_eur_thirdparty" style={{maskType:"luminance"}} maskUnits="userSpaceOnUse" x="0" y="0" width="24" height="24">
                                  <path d="M12 24C18.6274 24 24 18.6274 24 12C24 5.37258 18.6274 0 12 0C5.37258 0 0 5.37258 0 12C0 18.6274 5.37258 24 12 24Z" fill="white"/>
                                </mask>
                            ...
                            <span className="text-[#18181B] text-xl font-medium uppercase">{thirdPartyPaymentCurrency}</span>
                          </div>
                          <svg
                            width="24"
                            height="24"
                      ...
                      <input
                        ...
                        onChange={(e) => setThirdPartyPaymentAmount(e.target.value)}
                        placeholder="900.00"
                        className="text-[#18181B] text-right text-[28px] font-medium bg-transparent border-none outline-none w-32"
                      />
                    </div>
