...
export default function BusinessAccount4() {
  ...
  return (
    <div className="flex flex-col w-full h-screen overflow-y-auto bg-gradient-radial from-[#26272B] via-[#26272B] to-[#18181B] relative">
      {/* Main Content */}
      <div className="flex px-4 py-6 flex-col items-start gap-7 flex-1 self-stretch relative h-auto flex-grow-0 sm:h-auto sm:flex-1">
        {/* Header Row */}
      ...
      <div className="flex px-4 py-2 pb-0 flex-col items-start gap-6 flex-1 self-stretch relative">
        <div className="flex flex-col items-start gap-6 self-stretch relative max-h-[399px] overflow-y-auto">
          {/* Info Box */}
          <div className="flex px-3 py-3 items-center gap-3 self-stretch rounded-lg bg-white/8 sm:bg-transparent relative">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
