  ...
  return (
    <div className="w-full bg-[#fbfbfb] sm:bg-[#F4F4F5] flex flex-col" style={{ paddingBottom: 'calc(70px + env(safe-area-inset-bottom))' }}>
      ...
      <div className="fixed bottom-0 left-0 right-0 flex w-full max-w-md mx-auto h-[70px] p-1.5 items-start gap-1 border-t border-[#E4E4E7] bg-white z-50">
        <div className="flex p-2.5 flex-col justify-center items-center gap-1 flex-auto self-stretch rounded-lg border-b-[3px] border-[#18181B] bg-[#F4F4F5]">
        ...
        <div className="flex p-2.5 flex-col justify-center items-center flex-auto self-stretch rounded-lg">
          <svg width="24" height="24" viewBox="0 0 25 24" fill="none">
