...
export default function DashboardCrypto() {
  ...
  return (
    <div className="w-full min-h-screen bg-[#F4F4F5] flex flex-col">
      {/* Status Bar */}
      <div className="flex w-full h-11 px-5 py-3 justify-between items-center">
        ...
        <div className="flex items-center gap-1">
          ...
          <svg width="20" height="14" viewBox="0 0 20 14" fill="none">
            ...
            <path fillRule="evenodd" clipRule="evenodd" d="M16.5 2H17.5C18.0523 2 18.5 2.44772 18.5 3V11C18.5 11.5523 18.0523 12 17.5 12H16.5C15.9477 12 15.5 11.5523 15.5 11V3C15.5 2.44772 15.9477 2 16.5 2Z" fill="#18181B"/>
          </svg>
          {/* WiFi Icon */}
