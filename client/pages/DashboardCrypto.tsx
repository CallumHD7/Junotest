...
export default function DashboardCrypto() {
  ...
  return (
    <div className="w-full bg-[#fbfbfb] sm:bg-[#F4F4F5] flex flex-col" style={{ paddingBottom: 'calc(74px + env(safe-area-inset-bottom))' }}>
      ...
      {/* Bottom Navigation */}
      <div className="fixed bottom-0 left-0 right-0 flex w-full max-w-md mx-auto h-[70px] p-1.5 items-start gap-1 border-t border-[#E4E4E7] bg-white z-50" style={{ paddingBottom: 'env(safe-area-inset-bottom)' }}>
