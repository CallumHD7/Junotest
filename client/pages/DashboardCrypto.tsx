...
export default function DashboardCrypto() {
  ...
  return (
    <div className="w-full min-h-screen bg-[#fbfbfb] sm:bg-[#F4F4F5] flex flex-col">
            ...
            <div className="flex px-3 pb-3 items-start content-start gap-1 self-stretch flex-wrap">
              ...
              <div className="flex w-[169.5px] h-[140px] p-3 flex-col justify-between items-start rounded-md bg-[#F4F4F5]">
                <div className="w-11 h-11 rounded-full bg-[#E4E4E7] relative">
                  ...
                  <div className="w-6 h-6 rounded-full border-2 border-white bg-[#F7931A] absolute right-0 -top-1 overflow-hidden">
                    <img
                      src="https://cdn.builder.io/api/v1/image/assets%2F83d02907b4ae4e20b4c5791e73e38dc8%2F2177bb3c75af4680ae59e33dd1861ed8?format=webp&width=800"
                      alt="Crypto logo"
