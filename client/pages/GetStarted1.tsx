...
export default function GetStarted1() {
  ...
  return (
    <div className="flex flex-col w-full min-h-screen bg-gradient-radial from-[#26272B] via-[#26272B] to-[#18181B] relative">
      {/* Main Content */}
      <div className="flex px-4 py-6 md:p-6 flex-col items-start gap-6 flex-1 self-stretch relative">
        {/* Navigation Header */}
          ...
          <div className="flex flex-col items-start gap-8 flex-1 self-stretch relative">
            ...
            <div className="flex-1 self-stretch rounded-lg bg-gradient-to-b from-transparent to-[rgba(26,138,126,0.4)] relative overflow-hidden">
              <img
                ...
                alt=""
                className="absolute left-0 right-0 bottom-0 top-6 w-full h-full object-cover z-0 select-none pointer-events-none scale-[1.6] origin-center translate-y-[40px]"
              ...
              <img
                ...
                alt=""
                className="absolute z-20 w-[84px] h-[84px] top-[76px] left-[8px] select-none pointer-events-none drop-shadow-xl"
                                aria-hidden="true"
              />
              <img
