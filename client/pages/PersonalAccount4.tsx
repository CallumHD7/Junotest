...
export default function PersonalAccount4() {
  ...
  const ChevronDownIcon = () => (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" className="transform rotate-90">
      <path 
        d="M6.17474 8.70229C6.37626 8.50076 6.63275 8.4 6.9442 8.4C7.25565 8.4 7.51214 8.50076 7.71366 8.70229L12.0007 12.9893L16.2877 8.70229C16.4892 8.50076 16.7457 8.4 17.0572 8.4C17.3686 8.4 17.6251 8.50076 17.8266 8.70229C18.0281 8.90382 18.1289 9.1603 18.1289 9.47175C18.1289 9.7832 18.0281 10.0397 17.8266 10.2412L12.7701 15.2977C12.6602 15.4076 12.5411 15.4857 12.4129 15.5318C12.2846 15.578 12.1472 15.6007 12.0007 15.6C11.8541 15.6 11.7167 15.5769 11.5885 15.5307C11.4602 15.4846 11.3411 15.4069 11.2312 15.2977L6.17474 10.2412C5.97321 10.0397 5.87245 9.7832 5.87245 9.47175C5.87245 9.1603 5.97321 8.90382 6.17474 8.70229Z" 
        fill="#D1D1D6"
      />
    </svg>
  );
  ...
  return (
    <div className="flex flex-col w-full min-h-screen bg-gradient-radial from-[#26272B] via-[#26272B] to-[#18181B] relative">
      {/* Main Content */}
      <div className="flex p-4 md:p-6 flex-col items-start gap-7 flex-1 self-stretch relative">
