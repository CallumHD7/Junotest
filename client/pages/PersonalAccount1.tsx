...
export default function PersonalAccount1() {
  ...
  return (
    <div className="flex flex-col w-full h-screen bg-gradient-radial from-[#26272B] via-[#26272B] to-[#18181B] relative">
      {/* Main Content */}
      <div className="flex px-4 pt-6 flex-col items-start gap-7 self-stretch relative">
        {/* Back Button */}
        <button 
          onClick={handleBack}
      ...
      {/* Form Section */}
      <div className="flex px-4 pt-2 pb-0 flex-col items-start gap-8 flex-1 self-stretch relative overflow-y-auto">
