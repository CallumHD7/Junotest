...
export default function TransactionHistory() {
  ...
  return (
    <div className="w-full min-h-screen bg-[#F4F4F5] flex flex-col" style={{ paddingBottom: 'calc(70px + env(safe-area-inset-bottom))' }}>
      ...
      {/* Bottom Navigation */}
      <div className="fixed bottom-0 left-0 right-0 w-full h-[70px] bg-white border-t border-[#E4E4E7] flex items-start gap-1 p-1.5" style={{ paddingBottom: 'env(safe-area-inset-bottom)' }}>
        {/* Home Tab */}
        <button 
        ...
        <div className="flex-1 flex flex-col items-center justify-center gap-1 py-2.5 rounded-lg bg-[#F4F4F5] border-b-[3px] border-[#18181B]">
          <svg width="25" height="24" viewBox="0 0 25 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        {/* Contacts Tab */}
        <button className="flex-1 flex flex-col items-center justify-center py-2.5 rounded-lg">
          <svg width="25" height="24" viewBox="0 0 25 24" fill="none" xmlns="http://www.w3.org/2000/svg">
